  ...
  return (
    <div className = 'overflow-hidden max-w-[20vw] min-w-[200px]'>
      ...
      <div className='py-2'>
        ...
        <button onClick={()=>addToCart(id, size)} className = 'bg-[var(--green)] text-white text-md px-4 py-2 mt-4 mb-12 active:bg-[var(--yellow)] active:text-[var(--brown)] cursor-pointer'>Add to Cart</button>
      </div>      
    </div>
  )
}
